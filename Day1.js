...
let inventorSortBybirthdate = inventors.sort((a, b) => a.year > b.year);
console.log("Inventors arrange by oldest to youngest");
console.table(inventorSortBybirthdate);
...
console.log(`${totalYears} years did all the inventors live all together.`);

// 5. Sort the inventors by years lived
let inventorsSortByYearsLived = inventors.sort((a, b) => {
...
// let container = document.querySelector(".mw-page-container");
...
const transportationVehical = data.reduce((obj, item) => {
